...
public class City extends TableImpl<CityRecord> {
    ...
    private static final long serialVersionUID = 1807406026;
    ...
    /**
     * The column <code>CITY.CITY_RGN_ID</code>.
     */
    public final TableField<CityRecord, Integer> CITY_RGN_ID = createField("CITY_RGN_ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>CITY.CITY_NAME</code>.
     */
    public final TableField<CityRecord, String> CITY_NAME = createField("CITY_NAME", org.jooq.impl.SQLDataType.VARCHAR(30), this, "");

    /**
     * The column <code>CITY.CITY_TYPE</code>.
     */
    public final TableField<CityRecord, Integer> CITY_TYPE = createField("CITY_TYPE", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<UniqueKey<CityRecord>> getKeys() {
        return Arrays.<UniqueKey<CityRecord>>asList(Keys.INTEG_8);
    }
    ...
    public List<ForeignKey<CityRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<CityRecord, ?>>asList(Keys.INTEG_11);
    }

    public Region region() {
        return new Region(this, Keys.INTEG_11);
    }
